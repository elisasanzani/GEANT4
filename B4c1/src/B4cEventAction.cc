...
void B4cEventAction::PrintEventStatistics(
                              ...
                              G4double gapEdep, G4double gapTrackLength, G4double absoPosX, G4double gapPosX) const
{
  ...
  G4cout
    ...
    << G4endl
     << "       Abso Hit position X: "
     << std::setw(7) << G4BestUnit(absoPosX, "Length")
     << G4endl
    << "       Gap Hit position X: "
    << std::setw(7) << G4BestUnit(gapPosX, "Length")
    << G4endl;
}
...
{  
  ...
  if ( ( printModulo > 0 ) && ( eventID % printModulo == 0 ) ) {
    ...
    PrintEventStatistics(
      ...
      absoHit->GetPosX(), gapHit->GetPosX());
  }  
  ...
  analysisManager->FillH1(4, absoHit->GetPosX());
  analysisManager->FillH1(5, gapHit->GetPosX());
  ...
  analysisManager->FillNtupleDColumn(4, absoHit->GetPosX());
  analysisManager->FillNtupleDColumn(5, gapHit->GetPosX());
