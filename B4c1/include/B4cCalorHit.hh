...
inline G4ThreeVector B4cCalorHit::GetPos() const {
    return fPos;
}

inline G4double B4cCalorHit::GetPosX() const {
    return fPos.getX();
}

inline G4double B4cCalorHit::GetPosY() const {
    return fPos.getY();
}
...
//void B4cCalorHit::SetPos(G4ThreeVector xyz) {
//    fPos = xyz;
//}
