...
void B4cEventAction::PrintEventStatistics(
                              ...
                              G4double gapEdep, G4double gapTrackLength, G4double xCentroid, G4double yCentroid) const
{
  ...
  G4cout
     ...
     << G4endl
     << "        X of Centroid: "
     << std::setw(7) << G4BestUnit(xCentroid, "Length")
     << G4endl
     << "        Y of Centroid: "
     << std::setw(7) << G4BestUnit(yCentroid, "Length")
     << G4endl;
}
...
{  
  ...
  //Get centroid coordinates. come estraggo le x e y del centroide?
  G4double XCentroid=gapHit->GetCentroidX();
G4double YCentroid=gapHit->GetCentroidY();
  ...
  if ( ( printModulo > 0 ) && ( eventID % printModulo == 0 ) ) {
    ...
    PrintEventStatistics(
      ...
      gapHit->GetEdep(), gapHit->GetTrackLength(), XCentroid, YCentroid );
  }  
  ...
  analysisManager->FillH1(4, XCentroid);
  analysisManager->FillH1(5, YCentroid);
  ...
  analysisManager->FillNtupleDColumn(4, XCentroid);
  analysisManager->FillNtupleDColumn(5, YCentroid);
